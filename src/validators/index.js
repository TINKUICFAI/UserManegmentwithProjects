...
module.exports = {
  ...
  validations: {
    ...
    interest: {
      category: "required|exists:InterestSubCategory,_id|maxLength:250",
      interest: "required|exists:Interests,_id|maxLength:250",
    },
    question: {
      question: "required|string|exists:Question,_id|maxLength:250",
      answer: "required|string|maxLength:100",
    },
    category: {
      category: "required|string|exists:Category,_id|maxLength:250",
      sub_category: "required|string|exists:SubCategory,_id|maxLength:250",
    },
  },
};
